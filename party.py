...
def is_mel(name, email):
    ...
    False
    >>> is_mel("Mel Melitpolski", "emily@gmail.com")
    True
    >>> is_mel("emily", "mel@ubermelon.com")
    True
    >>> is_mel('MEL', 'test@test.com')
    True
    ...
    # return name.lower == "mel melitpolski" or email == "mel@ubermelon.com"
